...
public class AddMedicine_PharmacyAdapter extends BaseAdapter {

    public ArrayList<String> patient_appointments;
    public Context context;


    public AddMedicine_PharmacyAdapter(ArrayList<String> patient_appointments, Context context) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        View v = layoutInflater.inflate(R.layout.add_medicin_pharmacy,null);
