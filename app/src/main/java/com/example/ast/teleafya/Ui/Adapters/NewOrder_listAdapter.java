...
public class NewOrder_listAdapter extends BaseAdapter {

    public ArrayList<String> patient_appointments;
    public Context context;


    public NewOrder_listAdapter(ArrayList<String> patient_appointments, Context context) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        View v = layoutInflater.inflate(R.layout.neworder_listadapter,null);
