...
public class Past_Diagnostic_App extends BaseAdapter {

    public ArrayList<String> patient_appointments;
    public Context context;


    public Past_Diagnostic_App(ArrayList<String> patient_appointments, Context context) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        View v = layoutInflater.inflate(R.layout.item_past_dia_appointment,null);
