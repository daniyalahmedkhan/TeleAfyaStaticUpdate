...
public class Request_Diagnostic_Detail_Adp extends BaseAdapter {

    public ArrayList<String> patient_appointments;
    public Context context;


    public Request_Diagnostic_Detail_Adp(ArrayList<String> patient_appointments, Context context) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        View v = layoutInflater.inflate(R.layout.item_request_dia_detail,null);
