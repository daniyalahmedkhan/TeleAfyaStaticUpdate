...
import com.example.ast.teleafya.Ui.Diagnostic_Ui.Diagnostic_Appointment_Activity;
import com.example.ast.teleafya.Ui.Diagnostic_Ui.Diagnostic_HomeActivity;
import com.example.ast.teleafya.Ui.Diagnostic_Ui.Diagnostic_MessageActivity;
import com.example.ast.teleafya.Ui.Diagnostic_Ui.Diagnostic_Patient;
...
public class Partners_TransportHome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Navigations_ItemsAdapter navigations_itemsAdapter = new Navigations_ItemsAdapter(Partners_TransportHome.this, menuName, menuicons);
        mDrawerList.setAdapter(navigations_itemsAdapter);
        mDrawerList.addHeaderView(viewinflate);
        mDrawerList.addFooterView(viewinflate_footer);

        mDrawerToggle = new ActionBarDrawerToggle(Partners_TransportHome.this, drawer_layout, null, R.string.app_name, R.string.app_name) {
            @Override
