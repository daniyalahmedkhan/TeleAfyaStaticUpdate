...
public class Cancel_OrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newOrder_listAdapter = new NewOrder_listAdapter(arrayList, Cancel_OrderActivity.this);
        ...
        back_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Cancel_OrderActivity.this, Pharmacy_HomeActivity.class);
        ...
        new_order_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                getSupportFragmentManager()
                        .beginTransaction()
                        .replace(R.id.order_container, new Cancel_OrderDetails_Pharmacy())
                        .addToBackStack(null)
                        .commit();
