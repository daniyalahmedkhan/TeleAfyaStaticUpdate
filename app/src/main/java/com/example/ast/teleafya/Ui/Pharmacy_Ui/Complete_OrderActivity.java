...
public class Complete_OrderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_complete__order);
        ...
        newOrder_listAdapter = new NewOrder_listAdapter(arrayList,Complete_OrderActivity.this);
        ...
        back_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(Complete_OrderActivity.this,Pharmacy_HomeActivity.class);
        ...
        new_order_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                getSupportFragmentManager()
                        .beginTransaction()
                        .replace(R.id.order_container, new Complete_OrderDetails_Pharmacy())
                        .addToBackStack(null)
                        .commit();
            }
        });
